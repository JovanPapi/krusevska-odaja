...
import breadedYellowCheese from "./food-images/appetizers/breadedYellowCheese.jpg";
import chickenFingers from "./food-images/appetizers/chickenFingers.jpg";
import goatCheese from "./food-images/appetizers/goatCheese.jpg";
import grilledMushrooms from "./food-images/appetizers/grilledMushrooms.jpeg";
import hardCheese from "./food-images/appetizers/hardCheese.jpg";
import lutenka from "./food-images/appetizers/lutenka.jpg";
import makalo from "./food-images/appetizers/makalo.jpg";
import pie from "./food-images/appetizers/maznik-pie.jpg";
import meatJelly from "./food-images/appetizers/meatJelly.jpg";
import olives from "./food-images/appetizers/olives.jpg";
import omlette from "./food-images/appetizers/omlette.jpg";
import pieWithLeek from "./food-images/appetizers/pieWithLeek.jpg";
import pieWithSpinach from "./food-images/appetizers/pieWithSpinach.jpg";
import pindzhur from "./food-images/appetizers/pindzhur.jpg";
import pituliciWithGarlic from "./food-images/appetizers/pituliciWithGarlic.jpg";
...
import friesWithCheese from "./food-images/garnish-and-extras/friesWithCheese.jpg";
import garnish from "./food-images/garnish-and-extras/garnish.jpg";
...
import burgerLoveckaSmall from "./food-images/grill/burgerLoveckaSmall.jpg";
import chickenKabobs from "./food-images/grill/chickenKabobs.jpg";
import chickenSteak from "./food-images/grill/chickenSteak.jpg";
import chickenSteakInMushroomSauce from "./food-images/grill/chickenSteakInMushromSauce.jpg";
import fritters from "./food-images/grill/firtters.jpg";
import kebab from "./food-images/grill/kebab.jpg";
import makedonskaLarge from "./food-images/grill/makedonkaLarge.jpg";
import makedonskaSmall from "./food-images/grill/makedonkaSmall.jpg";
import naturEscalope from "./food-images/grill/naturEscalope.jpg";
import porkChop from "./food-images/grill/porkChop.jpg";
import porkKabobs from "./food-images/grill/porkKabobs.jpg";
import porkRib from "./food-images/grill/porkRib.jpeg";
import ramsteak from "./food-images/grill/ramsteak.jpg";
import sausageKrusevski from "./food-images/grill/sausageKrusevski.jpg";
import smokedBacon from "./food-images/grill/smokedBacon.jpg";
import troutFish from "./food-images/grill/troutFish.jpg";
...
export const grillImages = [
  ...
  sausageKrusevski,
  chickenSteak,
  chickenSteakInMushroomSauce,
  naturEscalope,
  wienerSchnitzel,
];

export const dishesToOrderImages = [
  krusevskiKukuruzOdaja,
  lambShirden,
  beanSoupWithFish,
  lambPotOdaja,
  sarmaOdaja,
...
export const specialitiesOfHouseImages = [
  krushevskaSabja,
  stuffedPorkFillet,
  porkMeatOnGrill,
  ribInTheOven,
...
export const cookedDishesImages = [
  macedonianPan,
  traditionalMeat,
  vealMuscleInBoletusSauce,
  bakedBeans,
  turlitava,
  leanSarma,
  sarmaWithMeat,
...
export const dessertsImages = [pancake, iceCream, muffin];

export const snacksImages = [peanuts, almond, pistachio, hazelnut];

export const drinksImages = [
  brandyTraditionalTikves,
  brandyTraditionalTikvesVS,
  brandyTraditionalTikvesWhite,
  cognac,
  gin,
  vodka,
  smirnoff,
  ...
  glassOfWine,
  glassOfWine,
  aleksandriaWhiteLarge,
  aleksandriaRedLarge,
  traminecLarge,
  temjanikaLarge,
  tgaLarge,
  rozeMiddle,
  aleksandriaWhiteSmall,
  aleksandriaRedSmall,
  traminecSmall,
  tgaSmall,
  aleksandriaCuveeWhite,
  aleksandriaCuveeRed,
  cabernetSauvignon,
  sauvignonBlanc,
  rkacateli,
  whiteWatherWhineWhiteAndRed,
  barovoWhiteAndRed,
  barovoWhiteAndRed,
  kamenitza,
  jelen,
  ...
  sprite,
  juice,
  pelisterkaSparklingSmall,
  pelisterkaStillSmall,
  pelisterkaSparklingLarge,
  pelisterkaMiddle,
  pelisterkaSparklingLarge,
];

interface MenuProductsImagesProps {
  [key: string]: string[];
}

export const menuProductImages: MenuProductsImagesProps = {
  SALADS: saladImages,
  GARNISH_AND_EXTRA: garnishAndExtrasImages,
  APPETIZERS: appetizersImages,
  GRILL: grillImages,
  DISHES_TO_ORDER: dishesToOrderImages,
  SPECIALITIES: specialitiesOfHouseImages,
  COOKED_DISHES: cookedDishesImages,
  DESSERTS: dessertsImages,
  SNACKS: snacksImages,
  DRINKS: drinksImages,
};
